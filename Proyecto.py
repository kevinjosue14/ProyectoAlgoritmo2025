...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            registrar_curso(cursos, notas)
        elif opcion == "2":
            mostrar_cursos(cursos, notas)
        elif opcion == "3":
            mostrar_promedio_general(notas)
        elif opcion == "4":
            contar_aprobados(notas)
        elif opcion == "5":
            buscar_curso(cursos, notas)
        elif opcion == "6":
            actualizar_nota(cursos, notas)
        elif opcion == "7":
            eliminar_curso(cursos, notas)
        elif opcion == "8":
